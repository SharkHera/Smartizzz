				...
				<div class="box box-border">
					<div class="box-body">
						<center>
							...
							<h1 style="font-family: Noto Sans;">Smartizz</h1>
						</center><br>
						<form method="post" action="register.php" enctype="multipart/form-data">
							...
							<div class="form-group text-center">
								<span class="text-mute">Already have an account! </span> <a href="login.php">Login </a> <span class="text-mute">Here..</span>
							</div>
