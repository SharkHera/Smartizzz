...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Smartizz</b></a>
        </div>
            ...
            <div class="col-md-12">
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        <tr style="color:black;"><th><center><b>S.N.</b></center></th><th><center><b>Quiz</b></center></th><th><center><b>Question Solved</b></center></th><th><center><b>Right</b></center></th><th><center><b>Wrong<b></center></th><th><center><b>Score</b></center></th>';
                        $c=0;
                        while($row=mysqli_fetch_array($q) )
                        {
                        $eid=$row['eid'];
                    ...
                    if(@$_GET['q']== 3) 
                    {
                        ...
                        <table class="table table-striped title1" >
                        <tr style="color:red"><th><center><b>Rank</b></center></th><th><center><b>Name</b></center></th><th><center><b>Email</b></center></th><th><center><b>Score</b></center></th></tr>';
                        $c=0;
...
<!-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Footer!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
<footer class="footer">
    <p>©Sharky-Foxie production all rights reserved</p>
  
      <img class="logo-2 prod" src="css/images/Sharky-Foxie.png" alt="boite de prod">
      <div class="logo-2">
        <div class="superpose">
          <a href="https://github.com/DevFoxie"><img class="logo-2 mini-logo" src="css/images/foxie.jpeg" alt="Foxie's Github"></a>
        </div>
        <a href="https://github.com/SharkHera"><img class="logo-2 mini-logo" src="css/images/Sharky(2).jpeg" alt="Sharky's GitHub"></a>
      </div>
  </footer>
</body>
</html>